...
class SiteApiKey extends Field
{
    /**
    ...
    public function render(AbstractElement $element)
    {
        ...
        $apiKey = $this->scopeConfig->getValue('VPuscasu_dealerlocator/api/site_api_key', $scope, $scopeId);
        
        // Set the value and type of the element
        $element->setType('hidden');
        $element->setValue($apiKey ? $apiKey : 'DEFAULT_API_KEY');
